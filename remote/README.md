...
You can also use dlt-viewer however I have found the wsl -> windows localhost
to not be always working.
But you should be able to add a new ECU with the **Interface Type** being **UDP
DLT**, and in the UDP tab the **Port** shall be **3490**.
